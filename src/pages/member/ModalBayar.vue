    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body">
          <div class="container text-center">
            ...
            <input
              ...
              v-model="nominalFormat"
              placeholder="Ketikan Nominal"
              class="form-control"
              pattern="[0-9]*"
              inputmode="numeric"
            />
        ...
        <div class="modal-footer flex-row justify-content-between">
          <button type="button" class="btn btn-secondary flex-grow-1 me-1" data-bs-dismiss="modal">
            Batal
          </button>
          <button
          ...
          >
            <div v-if="props.saving" class="spinner-border spinner-border-sm" role="status">
